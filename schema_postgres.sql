...
ALTER TABLE job_descriptions ALTER COLUMN application_status SET DEFAULT '관심';
UPDATE job_descriptions SET application_status = '관심' WHERE application_status = '검토 중';
